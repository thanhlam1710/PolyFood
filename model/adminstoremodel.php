<?php 
    class adminstoremodel extends Dmodel {
        public function __construct()
        {
           parent::__construct();
        }
        public function get_list_store($table){
            $sql = "SELECT *FROM $table ORDER BY id_store";
        ...
        public function get_storeId($table, $condition){
        ...
        public function insert_store($loadTable_menu, $data){
            return $this->db->insert_db($loadTable_menu, $data);
        } 
        public function update_store($table, $data,$condition) {
            return $this->db->update_db($table, $data,$condition);
        }
        public function delete_store($table, $condition) {
