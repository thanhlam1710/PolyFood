...
<div id="page-content-wrapper">
    ...
    <div class="container-fluid px-4">
        <div class="row my-5">
            <h3 class="fs-4 mb-3">Chỉnh sửa menu</h3>
            <div class="col">
                <?php
                    foreach($data['editmenu'] as $cateOne) {
                ?>
                <form action="<?php echo ROOT_URL ?>adminmenu/updatemenu/<?php echo $cateOne['id_menu'] ?>" method="post">
                    <div class="mb-3 mt-4">
                    ...
                    <div class="mb-3 mt-4">
                        ...
                        <input type="text" class="form-control" id="name_menu" name="name_menu" value="<?php echo $cateOne['name_menu'] ?>">
                    </div>
                    <div>
                        <input type="hidden" value="<?php echo $cateOne['id_menu'] ?>">
                        <input value="Cập nhật" name="updatemenu" type="submit" class="btn btn-danger px-4">
