...
const checkUsername = () => {
    ...
    if (!isRequire(userName)) {
        ...
        errorShow(userNameEle, `Phải chứa ít nhât ${min} kí tự và tối đa ${max} kí tự!`);
    } else {
...
const checkPass = () => {
    ...
    if (!isRequire(pass)) {
        ...
        errorShow(passEle, 'Phải ít nhất 8 kí tự gồm 1 chữ viết thường, 1 chữ viết hoa!');
    } else {
        successShow(passEle);
        validate = true;
    }
